...
Author: Tobias Reber
Version: 0.7
Usage: /home/ltgal/mf-chsdi3/.venv/bin/python translation2po.py /home/ltgal/mf-chsdi3/chsdi/locale/
"""
...
def main():
    YAML_FILE_NAME = 'translation2po.yaml'
    dir_path = os.path.dirname(os.path.realpath(__file__))
    yaml_file_path = os.path.join(dir_path, YAML_FILE_NAME)

    validate_params(sys.argv)
    yaml_conf = get_yaml(yaml_file_path)
